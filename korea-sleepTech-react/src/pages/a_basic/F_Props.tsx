...
function MultiProps({name = '전창현(기본값)', colorProps}: MultiPropsType) {
  // 여러 개의 props가 전달되더라도 하나의 객체로 전달받음
  // : 위 처럼 객체나 배열 내부의 요소들을 한번에 각각의 요소 변수에 할당하는
  //!   , 구조 분해 할당(비구조화 할당) 가능
...
const props = {
  ...
  return (
    <div>
      {/* 
        Props는 부모 컴포넌트 내에서 자식 컴포넌트에게 속성으로 값을 전달
      ...
      */}
      <Wrapper>
        <ChildComponent name='전창현' />
      </Wrapper>

      {/* 여러 개의 props 전달 */}
      <MultiProps name='문창배' colorProps='lightBlue' />
