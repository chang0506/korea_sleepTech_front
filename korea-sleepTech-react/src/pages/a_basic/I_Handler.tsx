  ...
  return (
    <div>
      ...
      */}
      ...
      <button onClick={handleButtonClick}>클릭(이벤트핸들러등록)</button>
      <button onClick={function() {
        console.log('버튼 클릭');  
      }}>클릭2(함수를 직접 정의)</button>
      <button onClick={() => console.log('Button Click')}>클릭3(화살표 함수를 직접 정의)</button>
      ...
      {/* 
        ...
        2) -handler 끝
          : 이벤트 동작 이름 + handler
          EX) clickHandler, SignUpSubmitHandler, mouseEnterHanger 등
      */}
