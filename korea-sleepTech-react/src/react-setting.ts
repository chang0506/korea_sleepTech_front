...
// cf) 핫 리로딩: 앱을 처음부터 다시 시작하지 않고,
// 새로운 코드 변경에 따른 해당 변경 사항만 실시간 반영하는 기능


// 2. npm run build: 프로모션 빌드 생성 (dist 폴더)
// 3. npm run prebiew: 빌드된 앱 미리보기 (build 후 사용가능)
...
/*
{
  ...
  "dependencies": { //! 애플리케이션 동작과 연관된 의존성
  ...
  "devDependencies": { //! 애플리케이션 동작과는 무관하지만 개발 시 필요한 의존성 라이브러리
    ...
    "globals": "^15.15.0",
    "typescript": "~5.7.2", //? TyepScript 컴파일러
