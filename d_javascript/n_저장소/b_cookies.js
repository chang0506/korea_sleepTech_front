...
// EX) 사용자 이름 쿠키 설정
// : "username"의 이름에 "JCH" 값을 저장
document.cookie = "username=jch; path=/;"
...
// b) 경로
// : 도메인 뒤에 이어지는 부분, 서버(사이트) 내의 특정 파일이나 페이지 위치를 나타냄 "naver.com/news", "google.com/email" 등
...
let expires = "expires=" + date.toUTCString(); // 시간을 협정 세계시
// "expires=시간문자열"
