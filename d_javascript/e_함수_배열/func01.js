...
// == Error(웹 문서 없음) ==
// let button1 = document.querySelector('.button1'); // 문서에서 버튼이라는 이름을 가진 쿼리가존재하는지 존재하면 버튼 변수에 담음
...
//& 3) 화살표 함수: 기존의 fuction 키워드를 화살표(=>)로 대체(간결한 작성)
// >> '호이스팅' 적용 X
// +) 항상 익명함수로 작성
...
/*
  ...
  - 조건부 함수 사용: 함수 표현식 (fuction + 함수명선택)
