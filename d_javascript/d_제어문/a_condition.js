...
let isTrue = true;
if (isTrue === true) console.log('isT는 참이다.'); // 사용하지말자
if (isTrue) console.log('isT는 참이다');

if (isTrue !== true) console.log('isT는 참이 아니다.'); // 사용하지말자
if (!isTrue) console.log('isT는 참이 아니다.');