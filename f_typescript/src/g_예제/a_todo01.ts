...
todos = addTodo(todos, 'task1');
todos = addTodo(todos, 'task2');
todos = addTodo(todos, 'task3');
todos = addTodo(todos, 'task4');
todos = addTodo(todos, 'task5');
console.log(todos);

todos = completedTodo(todos, 1);
todos = completedTodo(todos, 3);
todos = completedTodo(todos, 5);
console.log(todos);
