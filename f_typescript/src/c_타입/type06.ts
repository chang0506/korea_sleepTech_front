...
const str2 = '반갑습니다.'; // "반값습니다."타입
// str2 = 'h1'; - 리터럴 "반값습니다." 타입 (재선언 할 수 없음)
let str3: 'hi' = 'hi'; // 리터럴 hi 타입
...
//# +) 객체의 구조적 타이핑(덕 타이핑)
// : 객체의 타입을 실제 값보다 그 구조나 멤버에 의해 결정하는 방식
...
// greet(p3); // Person 타입 속성 구조와 일치하지 않아 Person으로 취급되지 않음
...
let userData: UserDataType = {
  ...
  age: 27,
  isStudent: true,
  // hobby: ['배그', '피파'] // 필요한 형식은 이 인덱스 시그니처에서 가져옵니다.
  // - 해당 인덱스 서명에 존재하지 않는 타입의 값
}

userData.email = 'j8970';
