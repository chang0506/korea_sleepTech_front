...
const str: MixedType = 'hi';
const num: MixedType = 123;
const isTrue: MixedType = true;
...
type isStrOrNum = string | number;

function doubleOrNothing(e: isStrOrNum) {
  if (typeof(e) === "number") {
    return e * 2;
...
const a = 123;
const b = 'Hello';
console.log(doubleOrNothing(a));
console.log(doubleOrNothing(b));
