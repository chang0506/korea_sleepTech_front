...
// 3. 제네릭 기본 문법
// : 사용할 컴포넌트(변수, 함수, 클래스 등)의 이름뒤에 <>(꺽쇠괄호)안에 '타입 변수'를 지정
...
console.log(pairOutput1);
console.log(pairOutput2);
...
console.log(pair2<string, string[]>('hello', 'hello'));
...
console.log(myGenericNumber.add(4, 6));
